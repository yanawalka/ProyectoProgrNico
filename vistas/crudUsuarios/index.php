                            ...
                            <div class="navbar-collapse collapse justify-content-between align-items-center w-100"
                                ...
                                <ul class="topBotomBordersOut navbar-nav mx-auto text-center">
                                    <li class="nav-item"><a class="nav-link font-weight-light"
                                            href="../crudUsuarios">Menu
                                            Principal</a></li>
                                    <li class="nav-item"> <a class="nav-link font-weight-light"
                                            href="../crudProductos">Sobre
                                            nosotros</a></li>
                                    <li class="nav-item"> <a class="nav-link font-weight-light"
                                            href="../crudMarcas">Nuestra
                                            ubicacion</a></li>
                                    <li class="nav-item"> <a class="nav-link font-weight-light"
                                            href="../crudProveedores">Platos
                                            principales</a></li>
                                    <li class="nav-item"> <a class="nav-link font-weight-light"
                                            href="../crudRoles">Menu</a></li>
                                    <li class="nav-item"> <a class="nav-link font-weight-light"
                                            href="../../bd/logica_logout.php">CERRAR SESION</a></li>
                                </ul>
                            </div>
                        </div>
                    </nav>
        ...
        <div class="grid">
            <div class="element3">
                <div class="contenedor3">
                    <h2 class="nomUsuario">Usuario: <?php //echo $_SESSION["s_usuario"];?></h2>
                </div>
            </div>
        </div>
    </header> -->
